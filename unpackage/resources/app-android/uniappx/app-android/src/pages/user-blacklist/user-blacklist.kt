...
open class GenPagesUserBlacklistUserBlacklist : BasePage {
    ...
    override fun `$initMethods`() {
        ...
        this.loadData = fun(loadComplete: (() -> Unit)?) {
            ...
            this.loading = true;
            uni_request<Result<UserItemResult>>(RequestOptions(url = getURL("/myblacklist/" + Math.floor(this.currentPage)), header = object : UTSJSONObject() {
                var token = getToken()
            }, success = fun(res){
                var r = res.data;
                if (r == null) {
