...
open class GenPagesUserBindphoneUserBindphone : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode(Fragment, null, utsArrayOf(
            ...
            createElementVNode("view", utsMapOf("class" to "login-page"), utsArrayOf(
                createElementVNode("text", utsMapOf("class" to "login-title"), "绑定"),
                ...
                , "type" to "tel", "placeholder" to "输入手机号", "maxlength" to 11, "confirm-type" to "send", "onConfirm" to _ctx.openGetCode), null, 8, utsArrayOf(
                    "modelValue",
                    "onUpdate:modelValue",
                    "onConfirm"
                )),
    ...
    override fun `$initMethods`() {
        this.openGetCode = fun() {
            ...
            uni_navigateTo(NavigateToOptions(url = "/pages/user-getcode/user-getcode?phone=" + this.phone + "&type=bindphone"));
        }
        ;
    }
