...
open class GenPagesUserFansListUserFansList : BasePage {
    ...
    override fun `$initMethods`() {
        ...
        this.loadData = fun(loadComplete: (() -> Unit)?) {
            ...
            this.loading = true;
            uni_request<Result<UserItemResult>>(RequestOptions(url = getURL("/user/" + this.user_id + "/fans/" + Math.floor(this.currentPage)), header = object : UTSJSONObject() {
                var token = getToken()
            }, success = fun(res){
                var r = res.data;
                if (r == null) {
